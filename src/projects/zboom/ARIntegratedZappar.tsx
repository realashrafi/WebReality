...
import { ARCanvas, ARMarker } from '@zappar/zappar-react-three-fiber';
...
const ARIntegratedZappar: React.FC = () => {
        ...
        >
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg">
                ...
                >
                    <ARMarker
                        type="qrcode"
                        qrCodeValue=".*" // تشخیص هر QR کدی
                        onMarkerFound={() => console.log('QR Marker Found')}
                    >
...
export default ARIntegratedZappar;