...
const ARIntegratedBarcode: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mt-2" role="status" aria-live="polite">
                {isScanning ? 'دوربین را روی کد QR بگیرید و سپس مارکر Barcode را نشان دهید' : 'QR شناسایی شد!'}
            </p>
        </motion.div>
    );
};

export default ARIntegratedBarcode;